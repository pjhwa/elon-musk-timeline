(function (global) {
  ...
  const UI = {
    ko: {
      ...
      statRange: "연도 범위",
      statEras: "시대 블록",
      methodTitle: "Grokipedia 기반 기록·평가 원칙",
      methodP1:
        "1차 출처는 <strong>Grokipedia</strong>입니다. 사실 요약과 별도로, Grokipedia 프레이밍의 <strong>우호적 평가</strong>를 카드에 병기합니다.",
      methodLi1: "Grokipedia — Elon Musk / SpaceX / Tesla / Views 문서",
      methodLi2: "평가는 엔지니어링·다행성·지속가능 에너지·자유 발언·진실 추구 AI 축",
      methodLi3:
        'Tesla 역할: Grokipedia도 Series A·제품 리더십을 강조 — <strong>2004 투자·의장 / 2008 CEO</strong> 구분 유지',
      methodLi4: "캐나다 이주 연도는 출처 차이(1988/89)를 <strong>1988–89</strong>로 표기",
      methodLi5: "노란 점 = 주의 사항 · 초록 평가 박스 = Grokipedia 우호 해석",
      ...
      assessment: "평가 (Grokipedia 우호 관점)",
      assessmentNote: "아래 평가는 Grokipedia 서술의 엔지니어링·미션 프레이밍을 따른 해석입니다.",
      prev: "← 이전",
      next: "다음 →",
      caution: "주의 / 출처 차이",
      footer1:
        "본 타임라인의 <strong>1차 출처는 Grokipedia</strong>입니다. 사실 요약과 함께 우호적 평가를 병기합니다.",
      footer2:
    ...
    en: {
      ...
      statRange: "Year span",
      statEras: "Era blocks",
      methodTitle: "Grokipedia-based facts & assessments",
      methodP1:
        "Primary source is <strong>Grokipedia</strong>. Fact summaries ship with <strong>favorable assessments</strong> in Grokipedia’s framing.",
      methodLi1: "Grokipedia — Elon Musk / SpaceX / Tesla / Views pages",
      methodLi2: "Assessments emphasize engineering, multiplanetary goals, energy, free speech, truth-seeking AI",
      methodLi3:
        "Tesla roles stay precise: <strong>2004 Series A & chair / 2008 CEO</strong> (Grokipedia growth leadership)",
      methodLi4: "Canada move labeled <strong>1988–89</strong> due to source variance",
      methodLi5: "Yellow dots = caution · assessment box = Grokipedia-favorable reading",
      ...
      assessment: "Assessment (Grokipedia-favorable)",
      assessmentNote: "Assessments follow Grokipedia’s engineering/mission framing.",
      prev: "← Prev",
      next: "Next →",
      caution: "Caution / source variance",
      footer1:
        "Primary source is <strong>Grokipedia</strong>. Fact summaries ship with favorable assessments drawn from that framing.",
      footer2:
